...
function firstQuestion() {
    ...
    Swal.fire({
        ...
        imageWidth: 300,
        imageHeight: 300,
        background: '#3a3a45 url("https://raw.githubusercontent.com/zukahai/Confess-Crush/main/img/iput-bg.jpg")',
...
init()
var wrong = new Audio('/static/sound/wrong.mp3');
...
$('#yes').click(async function() {
    ...
    Swal.fire({
        ...
        width: 900,
        padding: '3em',
        html: "<input type='text' class='form-control' id='txtReason' onmousemove=textGenerate()  placeholder='Cảm ơn ngta đi chòi:v'>",
        background: '#3a3a45 url("https://raw.githubusercontent.com/zukahai/Confess-Crush/main/img/iput-bg.jpg")',
        backdrop: `
              rgba(0,0,123,0.4)
              url("https://raw.githubusercontent.com/zukahai/Confess-Crush/main/img/giphy2.gif")
              left top
              no-repeat
            `,
